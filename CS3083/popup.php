        ...
        <div class="column">
            ...
            <div class="column ">
                ...
                <div class="boxSentencing" style="font-family: Fira Sans;line-height: 1.5;">
                    <h3>Sentence ID:
                        <?php echo $sentence['sentence_ID']; ?>
                    </h3>
                    <p>Sentence Type:
                        <?php echo $sentence['sentence_type']; ?>
                    </p>
                    <p>Probation Officer ID:
                        <?php echo $sentence['prob_ID']; ?>
                    </p>
                    <p>Start Date:
                        <?php echo $sentence['start_date']; ?>
                    </p>
                    <p>End Date:
                        <?php echo $sentence['end_date']; ?>
                    </p>
                    <p>Violations:
                        <?php echo $sentence['violations']; ?>
                    </p>
                    <a
