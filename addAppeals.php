...
<form method="post" action="addAppeals.php" onsubmit="return check(this);">
    <input type="hidden" name="m" value="<?php echo ($method == null) ? 'a' : 'u'; ?>"/>
    ...
    <select id="appeal_status" name="appeal_status" required style="width: 100%; padding: 8px; margin-bottom: 16px; box-sizing: border-box;">
