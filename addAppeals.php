...
if ($method == 'a') {
    ...
    $appeal = get_appeal_info_form_db();
} elseif ($method == 'u') {
    update_appeal();
} elseif ($method == 'd') {
    delete_appeal();
...
?>
    ...
    <tr>
        <th>Appeal ID: </th> 
        <td><input type="text" class="input" name="criminal_ID" maxlength="5"></td>
    </tr>

    <label for="crimeStatus">Appeal Status:</label>
    ...
    <label for="startDate">Filing Date:</label>
